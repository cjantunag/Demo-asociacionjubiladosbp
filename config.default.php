...
//define(_DEF_sqlcharacter_set,"utf8");
...
if ($V_CharCSV=="") $V_CharCSV="ISO-8859-1"; // formato de caracter de volcado csv
...
define("_DEF_KEYWORDS", "Web Mas Social Conecta promovida por Fundacion Barrie y Edisa");
define("_DEF_DESCRIPTION", "Mas Social Conecta es la herramienta web de comunicacion las Entidades Sociales");
define(_DEF_THEME,"MSC");
define(_DEF_COLUMNS,"1");
if ($HTTPS_SERVER[HTTPS]!="") $TMP_URL="https://";
else $TMP_URL="http://";
$TMP_URLSUBBROWSE=$TMP_URL."usuario:clave@".$GLOBALS["HTTP_HOST"].dirname($PHP_SELF);
...
define(_DEF_ADMINMAIL,"massocialconecta@edisa.com");
...
if ($HTTP_SESSION_VARS["SESSION_lang"]=="galician" || $newlang=="galician") {
	...
	define(_DEF_FOOT,'      <ul>
        ...
        <li style="width:450px !important;" class="promoven">
          <p>PROMOVEN:</p>
	  ...
	  <a href="http://www.edisa.com" target=_blank><img alt="Logo EDISA" src="themes/MSC/cierre_edisa.gif" width="145" height="83"></a> 
       </li>
        <li class="aviso">
