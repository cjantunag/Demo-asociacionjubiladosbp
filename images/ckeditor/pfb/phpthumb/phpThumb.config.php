...
if (!is_user()) die("Acceso denegado");
...
$PHPTHUMB_CONFIG['document_root']=str_replace("/images/ckeditor/pfb/phpthumb/phpThumb.config.php","",__FILE__);
...
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'].'/files/tmp/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $PHPTHUMB_CONFIG['document_root'].'/files/tmp/';  // set the cache directory for unprocessed source images
