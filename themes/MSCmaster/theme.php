...
<div id="supercontenedor">
  <div id="contenedor">
    <div id="cabecera">
      ...
      <div id="redes"><a href="'._DEF_FACEBOOK.'" target=_blank><img alt="Facebook" src="themes/'.$TMP_dirtheme.'/ico_facebook.png"></a> <a href="'._DEF_TWITTER.'" target=_blank><img alt="Twitter" src="themes/'.$TMP_dirtheme.'/ico_twitter.png"></a> <a href="'._DEF_YOUTUBE.'" target=_blank><img alt="Youtube" src="themes/'.$TMP_dirtheme.'/ico_youtube.png"></a></div>
