...
define("_ASREGISTERED","Ertu ekki enn með aðgang? Þú getur <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">skráð þig inn</a>. Sem skráður notandi getur þú til dæmis breytt útliti síðunnar og sent inn fréttir og athugasemdir undir þínu nafni.");
...
define("_YOUAREANON","Þú er ekki skráð(ur).  Þú getur skráð þig ókeypis með því að smella <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">hérna</a>");
define("_NOTE","Ath:");
