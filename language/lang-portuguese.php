...
define("_ASREGISTERED","Você ainda não tem uma conta? Pode criar uma <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">aqui</a>. Como utilizador registado, pode configurar o web site de acordo com as suas preferências, além de ter outras vantagens exclusivas.");
...
define("_YOUAREANON","Você ainda não é nosso utilizador. É grátis! Clique <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">aqui</a>");
define("_NOTE","Nota:");
define("_ADMIN","Admin:");
...
define("_DEF_NSLSpanish","Espanhol");
