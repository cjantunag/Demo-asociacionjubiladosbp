...
define("_ASREGISTERED","還沒有帳號嗎？<a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">請建立帳號</a>。完成註冊的使用者可以享受佈景主題管理，評註的組態調整及具名發表評論等功能。");
define("_MENUFOR","選單於");
...
define("_YOUAREANON","您正匿名使用中, 請來<a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">免費註冊</a>");
define("_NOTE","註：");
define("_ADMIN","管理");
