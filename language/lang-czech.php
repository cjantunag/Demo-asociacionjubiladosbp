...
define("_ASREGISTERED","Ještì nemáte svùj úèet? Mùžete si jej <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">vytvoøit zde</a>. Jako registrovaný uživatel získáte øadu výhod. Napøíklad posílání komentáøu pod jménem, nastavení komentáøù, manažer témat atd.");
...
define("_YOUAREANON","Jste anonymní uživatel. Mùžete se zdarma registrovat kliknutím <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">zde</a>");
