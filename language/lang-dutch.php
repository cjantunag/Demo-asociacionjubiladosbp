...
define("_ASREGISTERED","Nog geen lid? U kunt een account <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">aanvragen</a>. Als geregistreerde gebruiker krijgt u voordelen zoals de Thema-manager, opmerkingsconfiguratie en kunt u opmerkingen plaatsen onder uw eigen naam.");
...
define("_YOUAREANON","U bent een gast. U kunt gratis een account aanvragen door <a href=\"index.php?V_dir=admin&V_mod=nuevousuario&func=new\">hier</a> te klikken");
define("_NOTE","Noot:");
define("_ADMIN","Admin:");
