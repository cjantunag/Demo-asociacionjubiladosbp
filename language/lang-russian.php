...
define("_ASREGISTERED","Не зарегистрировались? Вы можете зделать это нажав <a href=\"index.php?V_dir=coremods&V_mod=feedback\">Здесь</a>. Когда вы зарегистрируетесь, вы получите полный доступ к управлению сайтом, сможите изменять его внешний вид по вашему желанию и т.д.");
...
define("_MODULEUSERS", "We are Sorry but this section of our site is for <i>Registered Users Only</i>");
