...
require_once("mainfile.php");
	...
	$idnames = "idfirma";
	$idname0 = "idfirma";
	if (empty($orderby)) $orderby = "idfirma";
	$rows_limit = 25;
	$V_colsedit = 1;
	$V_colsdetail = 1;
