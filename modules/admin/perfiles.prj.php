<?
	...
	$VONBLUR[$idx] = "";
	$COLUMN[$idx] = "";
	$HELP[$idx] = "C�digo �nico de tres caracteres";
	$DESCRIPTION[$idx] = "";
	$FUNCNEW[$idx] = "";
	$FUNCLINK[$idx] = "";
	$OVERLAP[$idx] = "Datos";
	...
	$TYPE[$idx] = "function";
	$DTYPE[$idx] = "function";
	$EXTRA[$idx] = "perfiles.usuarios.php";
	$VDEFAULT[$idx] = "";
	$LISTA[$idx] = "";
	$VONFOCUS[$idx] = "";
	$VONCHANGE[$idx] = "";
	...
	$TYPE[$idx] = "function";
	$DTYPE[$idx] = "function";
	$EXTRA[$idx] = "perfiles.modulos.php";
	$VDEFAULT[$idx] = "";
	$LISTA[$idx] = "";
	$VONFOCUS[$idx] = "";
	$VONCHANGE[$idx] = "";
	...
	$idx++;
	$TITLE[$idx] = "Activar M&oacute;dulos";
	$NAME[$idx] = "activarmodulos";
	$LENGTH[$idx] = "1";
	$ILENGTH[$idx] = "1";
	$ORDERBY[$idx] = "";
	$CANBENULL[$idx] = "";
	...
	$idx++;
	$TITLE[$idx] = "Listados";
	$NAME[$idx] = "gestion.listados";
	$LENGTH[$idx] = "20";
	$ILENGTH[$idx] = "20";
	$ORDERBY[$idx] = "gestion.listados";
	$CANBENULL[$idx] = "on";
	$TYPE[$idx] = "function";
	$DTYPE[$idx] = "function";
