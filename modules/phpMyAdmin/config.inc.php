...
$cfgServers[1]['host'] = _DEF_dbhost;           // MySQL hostname
$cfgServers[1]['port'] = '';                    // MySQL port - leave blank for default port
$cfgServers[1]['adv_auth'] = false;             // Use advanced authentication?
$cfgServers[1]['stduser'] = _DEF_dbuname;             // MySQL standard user (only needed with advanced auth)
$cfgServers[1]['stdpass'] = _DEF_dbpass;                 // MySQL standard password (only needed with advanced auth)
$cfgServers[1]['user'] = _DEF_dbuname;                // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = _DEF_dbpass;                // MySQL password (only needed with basic auth)
