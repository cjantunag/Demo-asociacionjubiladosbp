...
$strEdit = "Editar";
$strEmpty = "Vaciar";
$strEmptyResultSet = "SQL ha devuelto un valor vac&iacute;o (i.e. cero columnas).";
...
$strSQLReloaded = "Reinicio de SQL.";
$strSQLSaid = "SQL ha dicho: ";
$strSQLShowStatus     = "Mostrar informaci&oacute;n de marcha de SQL";
$strSQLShowVars       = "Mostrar las variables del sistema SQL";
$strName = "Nombre";
...
$strRecords             = "Campos";
$strReloadFailed        = "El reinicio de SQL ha fallado.";
$strReloadSQL = "Reinicio de SQL";
...
$strYes = "Si" ;
$strSQLShowProcess    = "Mostrar procesos";
$strLogout              = "Salir";
