...
<li>
<a href="?V_dir=<?=$V_dir?>&V_mod=<?=$V_mod?>&func=sql<?php echo $SESSION_SID;?>&db=<?php echo $db;?>&sql_query=<?php echo urlencode("DROP DATABASE $db");?>&zero_rows=<?php echo urlencode($strDatabase." ".$db." ".$strHasBeenDropped);?>&subfunc=db_details"><?php echo $strDropDB." ".$db;?></a> <?php print show_docu("manual_Reference.html#Drop_database");?>
