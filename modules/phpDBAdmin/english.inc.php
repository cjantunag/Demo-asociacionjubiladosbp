...
$strEdit		= "Edit";
$strEmpty		= "Empty";
$strEmptyResultSet	= "SQL returned an empty result set (i.e. zero rows).";
...
$strSQLReloaded	= "SQL reloaded.";
$strSQLSaid		= "SQL said: ";
$strSQLShowStatus     = "Show SQL runtime information";
$strSQLShowVars       = "Show SQL system variables";
$strName		= "Name";
$strNext		= "Next";
$strNo			= "No";
...
$strRecords             = "Records";
$strReloadFailed        = "SQL reload failed.";
$strReloadSQL		= "Reload SQL";
...
$strStruc1Data           = "Structure and one register";
...
$strYes			= "Yes";
$strSQLShowProcess    = "Show processes";
$strLogout              = "Log out";
